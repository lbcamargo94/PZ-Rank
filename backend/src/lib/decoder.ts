...
// Grupos: nome|prof|kills|tempo|skills|status|sandbox|traits — opcionais a partir do 6º
...
export function parsePzrCode(raw: string): DecodedCode | null {
  ...
  const [, characterName, profession, kills, timeRaw, skillsRaw, statusRaw, sandboxRaw, traitsRaw] = match;
