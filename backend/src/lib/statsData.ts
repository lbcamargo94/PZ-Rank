...
const STATS_ENTRY_COLS = [
  ...
  'season_id, death_cause, death_region, weapon_kills, mod_version, run_started_at',
...
const STATS_HISTORY_COLS = [
  ...
  'season_id, death_cause, death_region, weapon_kills, stats_synced_at, is_partial, run_started_at, run_ended_at',
  ...ACTION_KEYS,
].join(', ');
