...
function runMigrations(db: Database): void {
  ...
  for (const [col, type] of [['death_cause', 'TEXT'], ['run_started_at', 'TEXT'], ['death_region', 'TEXT'], ['heatmap_batch', 'TEXT'], ['weapon_kills', 'TEXT']] as const) {
  ...
  for (const col of ['death_region', 'weapon_kills']) {
