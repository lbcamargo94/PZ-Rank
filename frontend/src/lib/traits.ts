...
export const TRAITS: Record<string, TraitDef> = {
  ...
  Artisan:            { name: 'Artesão',                 type: 'positive', image: 'Artesão'                 },
  ...
  Blacksmith:         { name: 'Ferreiro',                type: 'positive', image: 'Ferreiro'                },
  Blacksmith2:        { name: 'Ferreiro Especialista',   type: 'positive', image: 'Ferreiro'                },
  ...
  Crafty:             { name: 'Engenhoso',               type: 'positive', image: 'Crafty'                  },
  ...
  Inventive:          { name: 'Inventivo',               type: 'positive', image: 'Inventive'               },
  Inventive_prof:     { name: 'Inventivo',               type: 'positive', image: 'Inventive'               },
  Jogger:             { name: 'Corredor',                type: 'positive', image: 'Corredor'                },
  Mason:              { name: 'Pedreiro',                type: 'positive', image: 'Mason'                   },
  ...
  WeightGain:         { name: 'Metabolismo Lento',       type: 'negative', image: 'WeightGain'              },
};
