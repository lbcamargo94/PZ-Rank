...
export const TRAITS: Record<string, TraitDef> = {
  ...
  FirstAider:         { name: 'Socorrista',              type: 'positive'                                    },
  FirstAid:           { name: 'Socorrista',              type: 'positive'                                    },
  ...
  Desensitized:       { name: 'Destemido',               type: 'positive', image: 'Viciado em adrenalina'   },
  ...
  Axeman:             { name: 'Lenhador',                type: 'positive'                                    },
  Artisan:            { name: 'Artesão',                 type: 'positive'                                    },
  BaseballPlayer:     { name: 'Jogador de Beisebol',     type: 'positive'                                    },
  Blacksmith:         { name: 'Ferreiro',                type: 'positive'                                    },
  Blacksmith2:        { name: 'Ferreiro Especialista',   type: 'positive'                                    },
  Brawler:            { name: 'Brigador',                type: 'positive'                                    },
  Burglar:            { name: 'Arrombador',              type: 'positive'                                    },
  Cook:               { name: 'Cozinheiro',              type: 'positive'                                    },
  Cook2:              { name: 'Cozinheiro Especialista', type: 'positive'                                    },
  Crafty:             { name: 'Engenhoso',               type: 'positive'                                    },
  Fishing:            { name: 'Pescador',                type: 'positive'                                    },
  FormerScout:        { name: 'Escoteiro',               type: 'positive'                                    },
  Gardener:           { name: 'Jardineiro',              type: 'positive'                                    },
  Gymnast:            { name: 'Ginasta',                 type: 'positive'                                    },
  Hiker:              { name: 'Sobrevivencialista',      type: 'positive'                                    },
  Inventive:          { name: 'Inventivo',               type: 'positive'                                    },
  Inventive_prof:     { name: 'Inventivo',               type: 'positive'                                    },
  Jogger:             { name: 'Corredor',                type: 'positive'                                    },
  Mason:              { name: 'Pedreiro',                type: 'positive'                                    },
  Mechanics:          { name: 'Mecânico Amador',         type: 'positive'                                    },
  Mechanics2:         { name: 'Mecânico Avançado',       type: 'positive'                                    },
  Nutritionist:       { name: 'Nutricionista',           type: 'positive'                                    },
  Nutritionist2:      { name: 'Nutricionista',           type: 'positive'                                    },
  Tailor:             { name: 'Costureiro',              type: 'positive'                                    },
  WeightLoss:         { name: 'Metabolismo Acelerado',   type: 'positive'                                    },
  Whittler:           { name: 'Entalhador',              type: 'positive'                                    },
  WildernessKnowledge:{ name: 'Conhecimento Selvagem',   type: 'positive'                                    },
