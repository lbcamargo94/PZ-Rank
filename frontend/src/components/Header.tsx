...
const COMPANION_URL = 'https://github.com/lbcamargo94/PZ-Rank-Companion/releases/download/v1.8.5/PZ.Rank.Companion.Setup.1.8.5.exe';
const COMPANION_VER = 'v1.8.5';
