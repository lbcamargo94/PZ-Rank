const DOWNLOAD_URL =
  'https://github.com/lbcamargo94/PZ-Rank-Companion/releases/download/v1.5.1/PZ.Rank.Companion.Setup.1.5.1.exe';
    ...
    <div className="download-banner">
      <div className="container download-banner-inner">
        ...
        <a href={DOWNLOAD_URL} className="btn-download" download>
          <i className="ti ti-download" aria-hidden="true" /> Baixar v1.5.1
        </a>
      </div>
    </div>
  );
