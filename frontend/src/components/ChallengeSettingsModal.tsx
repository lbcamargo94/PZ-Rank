...
const SETTINGS_GROUPS = [
  ...
  },
  {
    ...
    rows: [
      ...
      { label: 'Ruído de Voronoi',                  value: 'Não' },
  ...
  },
  {
    ...
    rows: [
      ...
      { label: 'Defesa máx. de armadura',           value: '90' },
      { label: 'Chance de arma equipada',           value: '10' },
  ...
  },
  {
    ...
    rows: [
      ...
      { label: 'Horas para migração',               value: '48.0h' },
      { label: 'Distância do som',                  value: '250' },
      { label: 'Tamanho da horda',                  value: '1' },
      { label: 'Variação do grupo da horda',        value: '20' },
      { label: 'Distância para formação de hordas', value: '10' },
  ...
  },
  {
    ...
    rows: [
      ...
      { label: 'Bombas de gasolina infinitas',      value: 'Não' },
  ...
  },
  {
    ...
    icon: 'ti-stairs-down',
    rows: [
      { label: 'Frequência de geração de porões',   value: 'Muito Frequentemente' },
      { label: 'Máx. horas de combustível de fogo', value: '12' },
    ],
  },
  {
    title: 'Natureza',
  ...
  },
  {
    ...
    rows: [
      ...
      { label: 'Decomposição de cadáveres',         value: '108.0h' },
      ...
      { label: 'Multiplicador de danos de cerca',   value: '1.3' },
    ],
  },
  {
    title: 'Ambiente — Mapa',
    ...
    rows: [
      ...
      { label: 'Permitir Mini-Mapa',                value: 'Sim' },
  ...
  },
  {
    ...
    rows: [
      ...
      { label: 'Fator de tensão muscular',          value: '0.8' },
  ...
  },
  {
    ...
    rows: [
      ...
      { label: 'Multiplicador de atração',          value: '1.3' },
      ...
      { label: 'Frequência de carros com alarme',   value: 'Muito Frequentemente' },
      ...
      { label: 'Dano ao jogador atingido por carro',value: 'Normal' },
