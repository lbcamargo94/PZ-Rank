...
const COMPANION_WIN_URL   = 'https://github.com/lbcamargo94/PZ-Rank-Companion/releases/download/v1.9.2/PZ.Rank.Companion.Setup.1.9.2.exe';
const COMPANION_MAC_ARM   = 'https://github.com/lbcamargo94/PZ-Rank-Companion/releases/download/v1.9.2/PZ.Rank.Companion.1.9.2.Mac.arm64.dmg';
const COMPANION_MAC_X64   = 'https://github.com/lbcamargo94/PZ-Rank-Companion/releases/download/v1.9.2/PZ.Rank.Companion.1.9.2.Mac.x64.dmg';
const COMPANION_VER       = 'v1.9.2';
